                            ...
                            <table class="table schedule-table">
                                ...
                                <tbody>
                                    <?php foreach ($schedule as $s): 
                                        $is_overdue = $s['status'] === 'PENDING' && strtotime($s['due_date']) < time();
                                        $row_class = $s['status'] === 'PAID' ? 'paid' : ($is_overdue ? 'overdue' : '');
                                    ?>
                                    <tr class="<?php echo $row_class; ?>">
                                        ...
                                        <td><?php echo formatCurrency($s['balance_after']); ?></td>
                                        <td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo formatCurrency($p['amount_paid']); ?></strong></td>
                                        <td><?php echo htmlspecialchars(str_replace('_', ' ', $p['payment_method'])); ?></td>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="detail-card">
                        ...
                        <div class="text-center mb-3">
                            ...
                            <h6 class="mt-2 mb-0"><?php echo htmlspecialchars($loan['first_name'] . ' ' . $loan['last_name']); ?></h6>
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo htmlspecialchars($loan['position_name'] ?? 'N/A'); ?></div>
                            </div>
                            <div class="info-item">
                    ...
                    <div class="detail-card">
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item completed">
                                <strong><?php echo $loan['status'] === 'REJECTED' ? 'Rejected' : 'Approved'; ?></strong>
                            ...
                            <div class="timeline-item completed">
                                ...
                                <small class="d-block text-muted">
                                    <?php echo date('M d, Y H:i', strtotime($loan['disbursed_at'])); ?>
...
<?php if ($is_hr && in_array($loan['status'], ['DISBURSED', 'ACTIVE'])): ?>
