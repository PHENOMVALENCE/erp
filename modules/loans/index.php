...
$loan_types = [];
try {
    $stmt = $conn->prepare("SELECT *, type_name as loan_type_name, max_repayment_months as max_term_months FROM loan_types WHERE company_id = ? AND is_active = 1");
    $stmt->execute([$company_id]);
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="status-badge <?= strtolower($loan['status']) ?>"><?= ucfirst(strtolower($loan['status'])) ?></span></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
