    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="loan-card">
                ...
                <?php if (in_array($loan['status'], ['DISBURSED', 'ACTIVE', 'COMPLETED'])): ?>
                ...
                <div class="mt-3 pt-3 border-top d-flex justify-content-between">
                    <div>
                        ...
                        <a href="schedule.php?id=<?php echo $loan['loan_id']; ?>" class="btn btn-outline-info btn-sm">
                            <i class="fas fa-calendar me-1"></i>Payment Schedule
                        </a>
                        <?php endif; ?>
                    </div>
