...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 22, 2025 at 11:13 AM
...
CREATE TABLE `loan_types` (
  ...
  `eligibility_months` int(11) DEFAULT 0,
...
ALTER TABLE `payroll_allowances`
  ...
  ADD KEY `idx_payroll_detail` (`payroll_detail_id`);
...
--
ALTER TABLE `leave_balances`
  ADD CONSTRAINT `leave_balances_ibfk_1` FOREIGN KEY (`leave_type_id`) REFERENCES `leave_types` (`leave_type_id`);
COMMIT;
